...
class BookMapperTest {
    ...
    class ToFilterTests {
        ...
        void shouldCreateFilterWithAllParameters() {
            // Act
            BookFilter result = bookMapper.toFilter("Test Title", "Test Author", BookGenre.FICTION);
        ...
        void shouldCreateFilterWithNullTitle() {
            // Act
            BookFilter result = bookMapper.toFilter(null, "Test Author", BookGenre.FICTION);
        ...
        void shouldCreateFilterWithNullAuthor() {
            // Act
            BookFilter result = bookMapper.toFilter("Test Title", null, BookGenre.MYSTERY);
        ...
        void shouldCreateFilterWithNullGenre() {
            // Act
            BookFilter result = bookMapper.toFilter("Test Title", "Test Author", null);
